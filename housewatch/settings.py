...
if TEST or DEBUG:
    ...
    PG_USER = get_from_env("PGUSER", "posthog_billing")
    PG_PASSWORD = get_from_env("PGPASSWORD", "posthog_billing")
    PG_PORT = get_from_env("PGPORT", "5433")
    PG_DATABASE = get_from_env("PGDATABASE", "posthog_billing")
else:
